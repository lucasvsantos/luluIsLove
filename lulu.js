...
(function ($) {
    ...
    var self = $.lulu = new function () { };

    $.extend(self, {

        luluBackgrounds: [
            'http://www.away.com.br/lulu/bg1.png'
        ],

        luluImgs: [
            'https://i.imgur.com/xH3L2Ll.jpg'
        ],
    ...
    //Run on jQuery ready
    $(function () {
        self.handleImages(self.luluImgs, 3000);
        self.handleLogo(self.luluBackgrounds, 3000);
    });
})(jQuery);